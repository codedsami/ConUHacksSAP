...
# Upload the predictions to MongoDB
import pandas as pd
...
collection = db['backend_predictedfireevents']

# Specify CSV file to import
csv_file = 'predicted_wildfire_occurrences_with_location.csv'
df = pd.read_csv(csv_file, sep=',')

# Convert DataFrame to dictionary format for MongoDB
data = df.to_dict(orient='records')

# remove predicted_fire column
df = df.drop(columns=['predicted_fire'])

# clear previous data from the collection
